...
if (fs.existsSync(path.join(__dirname, '..', '.git'))) {
  var revision = child_process.execSync('git rev-parse --short HEAD', { cwd: path.join(__dirname, '..') }).toString().replace('\n', ' ').trim();
